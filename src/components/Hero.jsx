      ...
      <div className="flex-1 flex flex-col gap-16 lg:gap-0 lg:grid lg:grid-cols-3 items-center justify-items-center relative z-10 w-full max-w-[1600px] mx-auto px-4 md:px-12">
        ...
        <div className="w-full text-center lg:text-left order-2 lg:order-1">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-6xl xl:text-8xl font-black text-text-bright leading-[0.85] tracking-tighter uppercase safe-heading">
              SAYAK<br />
              DAS
            </h1>
          </motion.div>
        ...
        <div className="w-full text-center lg:text-right order-3 lg:order-3 mt-8 lg:mt-0 px-4 md:px-0">
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1, ease: [0.25, 0.1, 0.25, 1] }}
          >
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-4xl xl:text-6xl font-black text-text-bright leading-[0.85] tracking-tighter uppercase mb-6 md:mb-8 safe-heading">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-4xl xl:text-6xl font-black leading-[0.85] tracking-tighter uppercase safe-heading" 
